    ...
    <Html>
      ...
      <Body style={emailStyles.main}>
        <Container style={emailStyles.container}>
          ...
          <Heading style={emailStyles.heading}>Påmelding ble ikke godkjent</Heading>
          <Text style={emailStyles.paragraph}>
            Din påmelding til <strong>{eventName}</strong> ble dessverre ikke godkjent.
          </Text>
          <Text style={emailStyles.paragraph}>
            <strong>Årsak:</strong> {reason}
          </Text>
          <Text style={emailStyles.paragraph}>Ta kontakt med arrangementet hvis du mener dette er en feil.</Text>
        </Container>
