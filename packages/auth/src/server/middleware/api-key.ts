...
import { parseBearer, parseBearerOptional } from "../bearer";

/**
 * Minimal API key type — the consuming app provides the full type.
 */
...
/**
 * Minimal API key service interface.
 */
export type ApiKeyServiceLike = {
