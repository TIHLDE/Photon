...
// Innskrivning endrer seg bare ved semesterskiftene rundt 1. august og
// 1. januar. 120 dager er det faste tallet som treffer dem best: fra tidlig
// september utløper det rett før vårsemesteret.
