...
export interface paths {
    ...
    "/api/event/{eventId}/registration/{userId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        EventRegisteredUser: {
             ...
             * @enum {string}
             */
            studyVerification?: "active" | "inactive" | "stale" | "unverified";
        };
