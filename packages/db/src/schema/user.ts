...
import { boolean, pgEnum, pgTableCreator, primaryKey, text, varchar } from "drizzle-orm/pg-core";
...
export const userSettings = pgTable("settings", {
  ...
  allowsPhotosByDefault: boolean("allows_photos_by_default").default(false).notNull(),
