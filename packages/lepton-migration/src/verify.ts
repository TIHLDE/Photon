...
export async function verify(db: NodePgDatabase<DbSchema>): Promise<void> {
    ...
    const checks = [
        ...
        { name: "Memberships", old: "group_membership", new: "org_group_membership" },
        ...
        { name: "Registrations", old: "content_registration", new: "event_registration" },
        { name: "Strikes", old: "content_strike", new: "event_strike" },
        { name: "Payments", old: "payment_order", new: "event_payment" },
        { name: "Priority Pools", old: "content_prioritypool", new: "event_priority_pool" },
        { name: "Favorites", old: "content_event_favorite_users", new: "event_favorite" },
        ...
        { name: "Submissions", old: "forms_submission", new: "form_submission" },
