...
describe("News System", () => {
  integrationTest(
    ...
    async ({ ctx }) => {
      ...
      await ctx.utils.giveUserPermissions(editor, ["news:create", "news:update"]);
      ...
      expect(newsWithImage.imageUrl).toBe("https://example.com/image.jpg");
      ...
      const creatorUpdateResponse = await creatorClient.api.news[":id"].$patch({
        param: { id: newsArticle.id },
        json: {
      ...
      const editorUpdateResponse = await editorClient.api.news[":id"].$patch({
        param: { id: newsArticle.id },
        json: {
      ...
      const unauthorizedUpdateResponse = await userClient.api.news[":id"].$patch({
        param: { id: newsArticle.id },
        json: {
          title: "Should fail",
        },
      ...
      const scopedUpdateResponse = await userClient.api.news[":id"].$patch({
      ...
      const scopedUpdateFailResponse = await userClient.api.news[":id"].$patch({
        param: { id: newsArticle.id },
        json: {
      ...
      const reactionResponse = await userClient.api.news[":id"].reactions.$post({
        param: { id: newsArticle.id },
        json: {
          emoji: "👍",
        },
      ...
      const updateReactionResponse = await userClient.api.news[":id"].reactions.$post({
        param: { id: newsArticle.id },
        json: {
          emoji: "❤️",
        },
      ...
      const reactionDisabledResponse = await userClient.api.news[":id"].reactions.$post({
        param: { id: newsWithImage.id },
        json: {
          emoji: "😂",
        },
      ...
      const newsWithReactionsResponse = await userClient.api.news[":id"].$get({
        param: { id: newsArticle.id },
      });
      ...
      // 15. Delete reaction
      const deleteReactionResponse = await userClient.api.news[":id"].reactions.$delete({
        param: { id: newsArticle.id },
      });
      ...
      const deleteAgainResponse = await userClient.api.news[":id"].reactions.$delete({
        param: { id: newsArticle.id },
      });
      ...
      const unauthorizedDeleteResponse = await userClient.api.news[":id"].$delete({
        param: { id: newsWithImage.id },
      });
      ...
      const creatorDeleteResponse = await creatorClient.api.news[":id"].$delete({
        param: { id: newsArticle.id },
      });
      ...
      const adminDeleteResponse = await adminClient.api.news[":id"].$delete({
        param: { id: newsWithImage.id },
      });
      ...
      const scopedDeleteResponse = await userClient.api.news[":id"].$delete({
