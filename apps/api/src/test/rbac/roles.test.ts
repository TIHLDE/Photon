  ...
  describe("user-role operations", () => {
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(assignUserRole(ctx, user.id, "nonexistent")).rejects.toThrow("Role not found: nonexistent");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const roles = await getUserRoles(ctx, user.id);
        expect(roles.filter((r) => r === "idempotent-role").length).toBe(1);
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const hasRole = await userHasRole(ctx, user.id, "unassigned-role");
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const hasAny = await userHasAnyRole(ctx, user.id, ["role-a", "role-b"]);
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const hasAny = await userHasAnyRole(ctx, user.id, ["other-role-a", "other-role-b"]);
  ...
  describe("role hierarchy", () => {
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const canManage = await userCanManageUser(ctx, admin.id, moderator.id);
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const canManage = await userCanManageUser(ctx, moderator.id, admin.id);
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const canManage = await userCanManageUser(ctx, user1.id, user2.id);
        expect(canManage).toBe(false);
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const canManage = await userCanManageUser(ctx, noRoleUser.id, targetUser.id);
        expect(canManage).toBe(false);
      },
      500_000,
    );
  ...
  describe("role permission management", () => {
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await assignRolePermissions(ctx, "perm-role", ["users:create", "users:update"]);
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const viewCount = role?.permissions?.filter((p) => p === "users:view").length;
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        await expect(assignRolePermissions(ctx, "nonexistent-role", ["users:view"])).rejects.toThrow("Role not found: nonexistent-role");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await setRolePermissions(ctx, "replace-perm-role", ["events:view"]);
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        await expect(setRolePermissions(ctx, "nonexistent-role", ["users:view"])).rejects.toThrow("Role not found: nonexistent-role");
      },
      500_000,
    );
  });
  ...
  describe("role deletion", () => {
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(deleteRole(ctx, noRoleUser.id, toDelete.id)).rejects.toThrow("User has no roles");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(deleteRole(ctx, admin.id, 99999)).rejects.toThrow("Role not found");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(deleteRole(ctx, lowUser.id, highRole.id)).rejects.toThrow("Cannot delete this role - insufficient hierarchy");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(deleteRole(ctx, user.id, sameRole.id)).rejects.toThrow("Cannot delete this role - insufficient hierarchy");
      },
      500_000,
    );
  });
  ...
  describe("role reordering", () => {
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(reorderRole(ctx, noRoleUser.id, toMove.id, 3)).rejects.toThrow("User has no roles");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(reorderRole(ctx, admin.id, 99999, 5)).rejects.toThrow("Role not found");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(reorderRole(ctx, user.id, highestRole.id, 5)).rejects.toThrow("Cannot modify your highest role");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(reorderRole(ctx, lowUser.id, highRole.id, 5)).rejects.toThrow("Cannot manage this role - insufficient hierarchy");
      },
      500_000,
    );
    ...
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        await expect(reorderRole(ctx, admin.id, toMove.id, 10)).rejects.toThrow("Cannot move role to or above your position");

        await expect(reorderRole(ctx, admin.id, toMove.id, 11)).rejects.toThrow("Cannot move role to or above your position");
      },
      500_000,
    );
  });
