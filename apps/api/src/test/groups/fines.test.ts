  ...
  describe("delete fine", () => {
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const response = await client.api.groups[":groupSlug"].fines[":fineId"].$delete({
          param: {
            groupSlug: group.slug,
  ...
  describe("get fine", () => {
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const response = await client.api.groups[":groupSlug"].fines[":fineId"].$get({
          param: {
            groupSlug: group.slug,
            fineId: fine.id.toString(),
          },
  ...
  describe("update fine", () => {
    integrationTest(
      ...
      async ({ ctx }) => {
        ...
        const response = await client.api.groups[":groupSlug"].fines[":fineId"].$patch({
          param: {
            groupSlug: group.slug,
            fineId: fine.id.toString(),
          },
