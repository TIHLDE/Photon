...
export const groupSchema = Schema(
  ...
  z.object({
    ...
    description: z.string().nullable().meta({ description: "Group description" }),
    contactEmail: z.string().nullable().meta({ description: "Group contact email" }),
    ...
    finesAdminId: z.string().nullable().meta({ description: "Group fines admin ID" }),
...
export const memberSchema = Schema(
  ...
  z.object({
    ...
    createdAt: z.string().meta({ description: "Membership creation timestamp" }),
    updatedAt: z.string().meta({ description: "Membership update timestamp" }),
  }),
);

export const memberListSchema = Schema("GroupMemberList", z.array(memberSchema));
