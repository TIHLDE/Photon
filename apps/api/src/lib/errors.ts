...
export class HTTPAppException extends HTTPException {
  ...
  /** 403 Forbidden */
  public static Forbidden(message = "You don't have permission to access this resource") {
  ...
  public static ValidationError(message = "Validation failed", errors?: unknown) {
    return new HTTPAppException({
      status: 422,
      message,
      meta: errors,
