...
import { authQueryOptions, createLoginRedirectUrl } from "~/api/auth";
...
export const Route = createFileRoute("/_MainLayout/profil/{-$userId}")({
  ssr: false,
  async beforeLoad({ params, location, context }) {
