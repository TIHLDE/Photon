...
const EventsCalendarView = ({ category }: EventsCalendarViewProps) => {
  ...
  const [filters, setFilters] = useState<Filters>({
    start_range: startOfMonth(new Date()).toISOString(),
    end_range: endOfMonth(new Date()).toISOString(),
  });
  ...
  return (
    <Calendar
      ...
      onSetDate={(date: Date) => {
        setFilters({
          start_range: startOfMonth(date).toISOString(),
          end_range: endOfMonth(date).toISOString(),
        });
      }}
    >
