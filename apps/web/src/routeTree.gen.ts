...
const DotPagesJobPostDetailsIndexRoute = DotPagesJobPostDetailsIndexRouteImport.update({
  id: "/stillingsannonser/$id/{-$urlTitle}",
  path: "/stillingsannonser/$id/{-$urlTitle}",
  getParentRoute: () => DotPagesMainLayoutRoute,
} as any);
const DotPagesNewsDetailsIndexRoute = DotPagesNewsDetailsIndexRouteImport.update({
