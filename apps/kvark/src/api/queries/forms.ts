...
type FormListFilters = Omit<
    QueryParamsHelper<"get", "/api/forms">,
    "page" | "pageSize"
>;
...
type SubmissionListFilters = Omit<
    QueryParamsHelper<"get", "/api/forms/{formId}/submissions">,
    "page" | "pageSize"
>;

export const getFormSubmissionsQuery = (
    formId: string,
    page: number,
