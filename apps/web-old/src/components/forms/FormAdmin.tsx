  ...
  const tabs = [
    {
      label: "Innstillinger",
      value: "settings",
      component: <FormDetailsEditor form={form} />,
    },
    {
      label: "Spørsmål",
      value: "questions",
      component: <FormFieldsEditor form={form} />,
    },
    {
      label: "Statistikk",
      value: "stats",
      component: <FormStatistics formId={form.id} />,
    },
    {
      label: "Innsenderstatistikk",
      value: "user-stats",
      component: <FormUserStatistics formId={form.id} />,
    },
    {
      label: "Alle svar",
      value: "answers",
      component: <FormAnswers formId={form.id} />,
    },
  ];
