...
function Fines() {
  ...
  const [finesFilter, setFinesFilter] = useState<{
    approved?: boolean;
    payed?: boolean;
  }>({ payed: false });
  ...
  } = useGroupUsersFines(slug || "-", finesFilter, {
    enabled: tab === "users",
  });
          ...
          <div className="flex items-center space-x-2">
            <Select
              ...
              onValueChange={(value) =>
                setFinesFilter((prev) => ({
                  ...prev,
                  approved: value === "true" ? true : value === "false" ? false : undefined,
                }))
              }
            >
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFinesFilter((prev) => ({
                  ...prev,
                  payed: value === "true" ? true : value === "false" ? false : undefined,
                }))
              }
            >
              <SelectTrigger className="w-[150px]">
