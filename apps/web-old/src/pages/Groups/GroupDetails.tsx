...
function GroupPage() {
  ...
  const tabs = [
    {
      label: "Om",
      link: linkOptions({ to: "/grupper/$slug", params: { slug: group.slug } }),
      icon: Info,
    },
    {
      label: "Arrangementer",
      link: linkOptions({
        to: "/grupper/$slug/arrangementer",
    ...
    },
    {
      label: "Bøter",
      link: linkOptions({
        to: "/grupper/$slug/boter",
        params: { slug: group.slug },
      }),
      icon: CircleDollarSign,
      hidden: !showFinesAndLaws,
    },
    {
      label: "Lovverk",
      link: linkOptions({
        to: "/grupper/$slug/lovverk",
        params: { slug: group.slug },
      }),
      icon: Scale,
      hidden: !showFinesAndLaws,
    },
    {
      ...
      link: linkOptions({
        to: "/grupper/$slug/sporreskjemaer",
        params: { slug: group.slug },
      }),
      icon: CircleHelp,
      hidden: !showForms,
