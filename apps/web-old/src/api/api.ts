...
export default {
  // InfoBanner
  getInfoBanners: (filters?: any) =>
    IFetch<PaginationResponse<InfoBanner>>({
      method: "GET",
      url: BANNER_ENDPOINT,
      data: filters || {},
    }),
  getInfoBanner: (bannerId: InfoBanner["id"]) =>
    IFetch<InfoBanner>({
      method: "GET",
      url: `${BANNER_ENDPOINT}/${bannerId}/`,
    }),
  getVisibleInfoBanners: (filters?: any) =>
    IFetch<Array<InfoBanner>>({
      method: "GET",
      url: `${BANNER_ENDPOINT}/visible`,
      data: filters || {},
    }),
  createInfoBanner: (item: InfoBanner) =>
    IFetch<InfoBanner>({
      method: "POST",
      url: `${BANNER_ENDPOINT}/`,
      data: item,
  ...
  deleteInfoBanner: (bannerId: InfoBanner["id"]) =>
    IFetch<RequestResponse>({
      method: "DELETE",
      url: `${BANNER_ENDPOINT}/${bannerId}/`,
    }),
  ...
  getEventPaymentOrder: (eventId: Event["id"], userId: User["user_id"]) =>
    IFetch<Order>({
      method: "GET",
      url: `${ORDER_ENPOINT}`,
      data: { user_id: userId, event: eventId },
    }),
  ...
  getRegistration: (eventId: Event["id"], userId: User["user_id"]) =>
    IFetch<Registration>({
      method: "GET",
      url: `${EVENTS_ENDPOINT}/${String(eventId)}/${EVENT_REGISTRATIONS_ENDPOINT}/${userId}/`,
    }),
  ...
  createRegistrationAdmin: (eventId: Event["id"], userId: User["user_id"]) =>
    IFetch<Registration>({
      method: "POST",
      url: `${EVENTS_ENDPOINT}/${eventId}/${EVENT_REGISTRATIONS_ENDPOINT}/add/`,
      data: { user: userId },
    }),
  ...
  getFormStatistics: (formId: string) =>
    IFetch<FormStatistics>({
      method: "GET",
      url: `${FORMS_ENDPOINT}/${formId}/statistics/`,
    }),
  createForm: (item: FormCreate) => IFetch<Form>({ method: "POST", url: `${FORMS_ENDPOINT}/`, data: item }),
  updateForm: (formId: string, item: FormUpdate) =>
    IFetch<Form>({
      method: "PUT",
      url: `${FORMS_ENDPOINT}/${formId}/`,
      data: item,
    }),
  ...
  getSubmissions: (formId: string, filters?: any) =>
    IFetch<PaginationResponse<UserSubmission>>({
      method: "GET",
      url: `${FORMS_ENDPOINT}/${formId}/${SUBMISSIONS_ENDPOINT}/`,
      data: filters || {},
    }),
  ...
  // EmojiReactions
  createReaction: (item: ReactionMutate) =>
    IFetch<Reaction>({
      method: "POST",
      url: `${EMOJI_ENDPOINT}/reactions/`,
      data: item,
    }),
  deleteReaction: (reactionId: Reaction["reaction_id"]) =>
    IFetch<RequestResponse>({
      method: "DELETE",
      url: `${EMOJI_ENDPOINT}/reactions/${reactionId}/`,
    }),
  ...
  // User
  getUserData: (userId?: User["user_id"]) =>
    IFetch<User>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${userId || ME_ENDPOINT}/`,
    }),
  getUserPermissions: () =>
    IFetch<UserPermissions>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${ME_ENDPOINT}/permissions/`,
    }),
  getUserBadges: (userId?: User["user_id"], filters?: any) =>
    IFetch<PaginationResponse<Badge>>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${userId || ME_ENDPOINT}/${BADGES_ENDPOINT}/`,
      data: filters || {},
    }),
  getUserEvents: (userId?: User["user_id"], filters?: any) =>
    IFetch<PaginationResponse<EventList>>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${userId || ME_ENDPOINT}/${EVENTS_ENDPOINT}/`,
      data: filters || {},
    }),
  getUserForms: (filters?: any) =>
    IFetch<PaginationResponse<Form>>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${ME_ENDPOINT}/${FORMS_ENDPOINT}/`,
      data: filters || {},
    }),
  getUserMemberships: (userId?: User["user_id"]) =>
    IFetch<PaginationResponse<Membership>>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${userId || ME_ENDPOINT}/${MEMBERSHIPS_ENDPOINT}/`,
    }),
  getUserMembershipHistories: (userId?: User["user_id"]) =>
    IFetch<PaginationResponse<MembershipHistory>>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${userId || ME_ENDPOINT}/${MEMBERSHIP_HISTORIES_ENDPOINT}/`,
    }),
  getUserStrikes: (userId?: User["user_id"]) =>
    IFetch<Array<Strike>>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${userId || ME_ENDPOINT}/${STRIKES_ENDPOINT}/`,
    }),
  getUsers: (filters?: any) =>
    IFetch<PaginationResponse<User>>({
      method: "GET",
      url: `${USERS_ENDPOINT}/`,
      data: filters || {},
    }),
  updateUserData: (userName: User["user_id"], item: Partial<User>) =>
    IFetch<User>({
      method: "PUT",
  ...
  getUserNotificationSettings: () =>
    IFetch<Array<UserNotificationSetting>>({
      method: "GET",
      url: `${NOTIFICATION_SETTINGS_ENDPOINT}/`,
    }),
  ...
  getUserNotificationSettingChoices: () =>
    IFetch<Array<UserNotificationSettingChoice>>({
      method: "GET",
      url: `${NOTIFICATION_SETTINGS_ENDPOINT}/choices/`,
    }),
  slackConnect: (slackCode: string) =>
    IFetch<RequestResponse>({
      method: "POST",
      url: `${USERS_ENDPOINT}/${ME_ENDPOINT}/slack/`,
      data: { code: slackCode },
    }),
  activateUser: (userName: User["user_id"]) =>
    IFetch<RequestResponse>({
      method: "POST",
      url: `${USERS_ENDPOINT}/activate/`,
      data: { user_id: userName },
    }),
  declineUser: (userName: User["user_id"], reason: string) =>
    IFetch<RequestResponse>({
      method: "POST",
      url: `${USERS_ENDPOINT}/decline/`,
      data: { user_id: userName, reason },
    }),
  exportUserData: () =>
    IFetch<RequestResponse>({
      method: "GET",
      url: `${USERS_ENDPOINT}/${ME_ENDPOINT}/data/`,
    }),
  ...
  getNotifications: (filters?: any) =>
    IFetch<PaginationResponse<Notification>>({
      method: "GET",
  ...
  updateNotification: (id: number, item: { read: boolean }) =>
    IFetch<Notification>({
      method: "PUT",
      url: `${NOTIFICATIONS_ENDPOINT}/${String(id)}/`,
      data: item,
    }),

  // Short links
  getShortLinks: (filters?: any) =>
    IFetch<Array<ShortLink>>({
      method: "GET",
      url: `${SHORT_LINKS_ENDPOINT}/`,
      data: filters || {},
    }),
  createShortLink: (item: ShortLink) =>
    IFetch<ShortLink>({
      method: "POST",
      url: `${SHORT_LINKS_ENDPOINT}/`,
      data: item,
  ...
  deleteShortLink: (slug: string) =>
    IFetch<RequestResponse>({
      method: "DELETE",
      url: `${SHORT_LINKS_ENDPOINT}/${slug}/`,
    }),

  // Gallery
  getGallery: (id: Gallery["id"]) => IFetch<Gallery>({ method: "GET", url: `${GALLERY_ENDPOINT}/${id}/` }),
  getGalleries: (filters?: any) =>
    IFetch<PaginationResponse<Gallery>>({
      method: "GET",
      url: `${GALLERY_ENDPOINT}/`,
      data: filters || {},
    }),
  createGallery: (item: GalleryCreate) =>
    IFetch<Gallery>({
      method: "POST",
      url: `${GALLERY_ENDPOINT}/`,
      data: item,
    }),
  updateGallery: (id: Gallery["id"], item: Partial<Gallery>) =>
    IFetch<Gallery>({
      method: "PUT",
      url: `${GALLERY_ENDPOINT}/${id}/`,
      data: item,
    }),
  ...
  getGalleryPictures: (galleryId: Gallery["id"], filters?: any) =>
    IFetch<PaginationResponse<Picture>>({
      method: "GET",
      url: `${GALLERY_ENDPOINT}/${galleryId}/${PICTURE_ENDPOINT}/`,
      data: filters || {},
    }),
  getPicture: (galleryId: Gallery["id"], pictureId: Picture["id"]) =>
    IFetch<Picture>({
      method: "GET",
      url: `${GALLERY_ENDPOINT}/${galleryId}/${PICTURE_ENDPOINT}/${pictureId}`,
    }),
  ...
  deleteStrike: (id: string) =>
    IFetch<RequestResponse>({
      method: "DELETE",
      url: `${STRIKES_ENDPOINT}/${id}/`,
    }),
  getStrikes: (filters?: any) =>
    IFetch<PaginationResponse<StrikeList>>({
      method: "GET",
      url: `${STRIKES_ENDPOINT}/`,
      data: filters || {},
    }),
  ...
  getBadges: (filters?: any) =>
    IFetch<PaginationResponse<Badge>>({
      method: "GET",
      url: `${BADGES_ENDPOINT}/`,
      data: filters || {},
    }),
  createUserBadge: (data: { flag: string }) =>
    IFetch<RequestResponse>({
      method: "POST",
      url: `${USERS_ENDPOINT}/${ME_ENDPOINT}/${BADGES_ENDPOINT}/`,
      data,
    }),
  getBadgeLeaderboard: (badgeId: Badge["id"], filters?: any) =>
    IFetch<PaginationResponse<BadgeLeaderboard>>({
      method: "GET",
      url: `${BADGES_ENDPOINT}/${badgeId}/${BADGES_LEADERBOARD_ENDPOINT}/`,
      data: filters || {},
    }),
  getOverallBadgesLeaderboard: (filters?: any) =>
    IFetch<PaginationResponse<BadgesOverallLeaderboard>>({
      method: "GET",
      url: `${BADGES_ENDPOINT}/${BADGES_LEADERBOARD_ENDPOINT}/`,
      data: filters || {},
    }),
  getBadgeCategories: (filters?: any) =>
    IFetch<PaginationResponse<BadgeCategory>>({
      method: "GET",
      url: `${BADGES_ENDPOINT}/${BADGE_CATEGORIES_ENDPOINT}/`,
      data: filters || {},
    }),
  getBadgeCategory: (badgeCategoryId: BadgeCategory["id"]) =>
    IFetch<BadgeCategory>({
      method: "GET",
      url: `${BADGES_ENDPOINT}/${BADGE_CATEGORIES_ENDPOINT}/${badgeCategoryId}/`,
    }),
  ...
  getMemberships: (groupSlug: Group["slug"], filters?: any) =>
    IFetch<PaginationResponse<Membership>>({
      method: "GET",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${MEMBERSHIPS_ENDPOINT}/`,
      data: filters || {},
    }),
  ...
  deleteMembership: (groupSlug: Group["slug"], userId: User["user_id"]) =>
    IFetch<RequestResponse>({
      method: "DELETE",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${MEMBERSHIPS_ENDPOINT}/${userId}/`,
    }),
  ...
  getGroupStatistics: (slug: Group["slug"]) =>
    IFetch<GroupMemberStatistics>({
      method: "GET",
      url: `${GROUPS_ENDPOINT}/${slug}/statistics/`,
    }),
  ...
  // Group laws
  getGroupLaws: (groupSlug: Group["slug"]) =>
    IFetch<Array<GroupLaw>>({
      method: "GET",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_LAWS_ENDPOINT}/`,
    }),
  ...
  updateGroupLaw: (groupSlug: Group["slug"], lawId: GroupLaw["id"], data: GroupLawMutate) =>
    IFetch<GroupLaw>({
      method: "PUT",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_LAWS_ENDPOINT}/${lawId}/`,
      data,
    }),
  ...
  getGroupFines: (groupSlug: Group["slug"], filters?: any) =>
    IFetch<PaginationResponse<GroupFine>>({
      method: "GET",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_FINES_ENDPOINT}/`,
      data: filters || {},
    }),
  getGroupFinesStatistics: (groupSlug: Group["slug"]) =>
    IFetch<GroupFineStatistics>({
      method: "GET",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_FINES_ENDPOINT}/statistics/`,
    }),
  ...
  updateGroupFine: (groupSlug: Group["slug"], fineId: GroupFine["id"], data: GroupFineMutate) =>
    IFetch<GroupFine>({
      method: "PUT",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_FINES_ENDPOINT}/${fineId}/`,
      data,
    }),
  updateGroupFineDefense: (groupSlug: Group["slug"], fineId: GroupFine["id"], data: GroupFineDefenseMutate) =>
    IFetch<GroupFine>({
      method: "PUT",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_FINES_ENDPOINT}/${fineId}/defense/`,
      data,
    }),
  batchUpdateGroupFine: (groupSlug: Group["slug"], data: GroupFineBatchMutate) =>
    IFetch<RequestResponse>({
      method: "PUT",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_FINES_ENDPOINT}/batch-update/`,
      data,
    }),
  batchUpdateUserGroupFines: (groupSlug: Group["slug"], userId: User["user_id"], data: GroupFineMutate) =>
    IFetch<RequestResponse>({
      method: "PUT",
      url: `${GROUPS_ENDPOINT}/${groupSlug}/${GROUP_FINES_ENDPOINT}/batch-update/${userId}/`,
      data,
    }),
  ...
  //Group forms
  getGroupForms: (slug: string) =>
    IFetch<Array<GroupForm>>({
      method: "GET",
      url: `${GROUPS_ENDPOINT}/${slug}/${FORMS_ENDPOINT}/`,
    }),
  ...
  // Feedback
  getFeedbacks: (filters?: any) =>
    IFetch<PaginationResponse<Feedback>>({
      method: "GET",
