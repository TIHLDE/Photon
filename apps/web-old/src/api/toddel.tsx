...
export const TODDEL_API = {
  ...
  getToddels: (filters?: any) =>
    IFetch<PaginationResponse<Toddel>>({
      method: "GET",
      url: `${TODDEL_ENDPOINT}/`,
      data: filters || {},
    }),
  createToddel: (data: ToddelMutate) => IFetch<Toddel>({ method: "POST", url: `${TODDEL_ENDPOINT}/`, data }),
  updateToddel: (edition: Toddel["edition"], data: ToddelMutate) =>
    IFetch<Toddel>({
      method: "PUT",
      url: `${TODDEL_ENDPOINT}/${edition}/`,
      data,
    }),
  deleteToddel: (edition: Toddel["edition"]) =>
